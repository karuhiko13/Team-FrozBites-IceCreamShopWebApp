<header class="header">
    <section class="flex">
        ...
        <form action="search_product.php" method="post" class="search-form">
            <input type="text" name="search_product" placeholder="What are you looking for?" required maxlength="140">
        ...
        <div class="profile-detail">
            ...
            <div class="flex-btn">
                ...
                <a href="components/user_logout.php" onclick="return confirm('Are you sure you want to log out?');"
                    class="btn">Logout</a>
            </div>
            <?php }else{ ?>
